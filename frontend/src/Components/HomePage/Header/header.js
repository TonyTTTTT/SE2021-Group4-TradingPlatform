    ...
    return (
        <Container className="d-flex justify-content-between flex-column" style={{height:"100%",width:"100%"}}>
            <Row className="d-flex justify-content-left ">  
                <Button variant="outline-success"  disabled = {props.header.enableNew} onClick={onNewButtonClick} style={{margin:"40% 0% 10% 0%",width:100 ,height:60}}> New <input hidden type="file" name="file" onChange={onNewInputChange} ref={(input) => newInput = input}/></Button> 

                <Button variant="outline-success" disabled ={props.header.enableUpdate} onClick={onUpdateButtonClick} style={{margin:"10% 0% 10% 0%",width:100,height:60}}> Update <input hidden type="file" name="file" onInput={onUpdateInputChange} ref={(input)=> updateInput = input}/></Button>

                <Button variant="outline-success"   onClick={onDeleteButtonClick} style={{margin:"10% 0% 10% 0%",width:100 ,height:60}}> Delete </Button>    
            </Row>
